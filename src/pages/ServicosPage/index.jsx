  ...
  return (
    <div>
      ...
      <DetalhesServico
        ...
        paragrafo={`
          Pensando na melhor forma de proteger você e a sua família, o seguro de vida garante a sua proteção financeira em casos de invalidez e doenças graves, e ainda, ampara seus dependentes em caso de falecimento.ações.
        `}
      />
      <DetalhesServico
        image={seguroPrevidencia}
        style={"bg-zinc-50 md:order-1"}
        title={"Previdência Privada"}
        paragrafo={`
        Escolhendo planos que atendem às suas necessidades, a previdência privada não está ligada ao Instituto Nacional do Seguro Social (INSS). A partir de contribuições únicas ou mensais, ela te ajudará a acumular recursos financeiros para complementar a sua aposentadoria.
        `}
      />
      <DetalhesServico
        image={seguroFamilia}
      ...
      />
      <DetalhesServico
        image={seguroConsorcio}
        title={"Consórcio"}
        paragrafo={`
        O consórcio é uma modalidade de crédito baseada na união de pessoas, físicas ou jurídicas, que se reúnem para formar poupança em grupo, destinada à aquisição de um bem.       
        `}
      />
    </div>
  );
